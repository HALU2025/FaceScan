...
\`\`\`
----------------------------
キャッチフレーズ:<b>{10文字以内のフレーズ}</b>
{美人度/イケメン度}: <span style="font-size:24px; font-weight:bold;">{スコア}</span>点
推定年齢: {〇〇歳}
{評価軸1} {スコア}点
{評価軸2} {スコア}点
{評価軸3} {スコア}点
